            ...
            <main class="layout d-flex">
                ...
                <section class="page-content flex-grow-1 pt-5 px-4">
                    <div class="container-fluid">
                        ...
                        <div class="search-bar-container shadow-sm rounded bg-white p-3 mb-3">
                            <x-modals.shared-search-bar :action="route('user.report.list')" :search="$search ?? ''" :status="$status ?? ''"
